-- Migration : Ajout des catégories FILLEUL et FILLEUL_DESINSCRIT + champ parrain_id
-- Date : 2026-01-18

-- Étape 1 : Créer une nouvelle table avec les nouvelles catégories et le champ parrain_id
...
-- Étape 5 : Recréer les index si nécessaires
