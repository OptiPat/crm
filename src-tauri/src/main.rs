...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            get_pipe_r1_document_checklist,
            ...
            update_pipe,
            delete_pipe,
            list_parrainage_pipes,
            get_parrainage_pipe_by_id,
            create_parrainage_pipe,
            update_parrainage_pipe,
            set_parrainage_pipe_stage,
            ...
            replace_pipe_rdv_reminder_schedules,
            cancel_pipe_rdv_reminder_schedules,
            list_due_pipe_rdv_reminder_schedules,
            mark_pipe_rdv_reminder_schedule_sent,
            ...
            restore_db_backup,
            export_full_archive,
            get_external_backup_settings,
            set_external_backup_directory,
