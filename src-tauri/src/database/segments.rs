...
impl super::Database {
    ...
    pub fn ensure_link_default_etiquettes_to_segments(&self) -> Result<()> {
        ...
        let pairs: &[(&str, &str)] = &[
            ...
            ("Prospect jamais contacté", "Lead jamais contacté"),
            ("Filleul jamais contacté", "Filleul jamais contacté"),
            ("Filleul suivi > 6 mois", "Filleul prospect > 6 mois"),
            ("Filleul suivi > 1 an", "Filleul > 1 an"),
