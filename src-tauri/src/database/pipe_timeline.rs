...
pub const TIMELINE_VERSEMENT_PARTENAIRE: &str = "VERSEMENT_PARTENAIRE";
pub const TIMELINE_SOUSCRIPTION_PARTENAIRE: &str = "SOUSCRIPTION_PARTENAIRE";
...
const USER_TIMELINE_TYPES: &[&str] = &[
    ...
    TIMELINE_VERSEMENT_PARTENAIRE,
    TIMELINE_SOUSCRIPTION_PARTENAIRE,
];
