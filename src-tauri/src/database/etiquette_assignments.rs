...
impl Database {
    ...
    pub fn ensure_default_etiquettes(&self) -> Result<usize> {
        ...
        let default_etiquettes = vec![
            ...
            (
                "Prospect jamais contacté",
                "#EAB308",
                "🟡",
                "Prospect ou suspect client sans date de dernier contact",
                94,
                "JAMAIS_CONTACT",
                r#"{}"#,
                r#"["SUSPECT_CLIENT", "PROSPECT_CLIENT"]"#,
            ),
            (
                "Filleul jamais contacté",
                "#EAB308",
                "⚪",
                "Filleul prospect ou suspect sans date de suivi filleul",
                93,
                "JAMAIS_CONTACT",
                r#"{}"#,
                r#"["PROSPECT_FILLEUL", "SUSPECT_FILLEUL"]"#,
            ),
            (
                "Filleul suivi > 6 mois",
                "#EAB308",
                "🟡",
                "Filleul prospect/suspect sans suivi depuis plus de 6 mois",
                92,
                "DELAI_SANS_CONTACT",
                r#"{"jours": 180, "inclure_sans_date": false}"#,
                r#"["PROSPECT_FILLEUL", "SUSPECT_FILLEUL"]"#,
            ),
            (
                "Filleul suivi > 1 an",
                "#EF4444",
                "🔴",
                "Filleul actif sans suivi depuis plus d'un an",
                91,
                "DELAI_SANS_CONTACT",
                r#"{"jours": 365, "inclure_sans_date": false}"#,
                r#"["FILLEUL"]"#,
