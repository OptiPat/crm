...
Write-Host ""
Write-Host "Contact ID 349 (Aleksandra DEBBAGHI):" -ForegroundColor Cyan
sqlite3 $dbPath.FullName "SELECT id, nom, prenom, date_naissance, date_dernier_contact, date_prochain_suivi, profil_risque_sri FROM contacts WHERE id = 349;"
