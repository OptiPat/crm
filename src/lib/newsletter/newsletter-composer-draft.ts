...
function parseContent(value: unknown): GeneratedNewsletterContent | null {
  ...
  return {
    ...
    legalMentions: typeof c.legalMentions === "string" ? c.legalMentions : "",
    includeLegalMentions: c.includeLegalMentions === true ? true : undefined,
    includeConseiller: c.includeConseiller === true ? true : undefined,
    includeFooterPhone: c.includeFooterPhone === false ? false : undefined,
    includeFooterSite: c.includeFooterSite === false ? false : undefined,
    includeFooterAddress: c.includeFooterAddress === false ? false : undefined,
    includeFooterConseiller: c.includeFooterConseiller === false ? false : undefined,
