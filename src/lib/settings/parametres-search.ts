...
export const PARAMETRES_SEARCH_INDEX: ParametresSearchItem[] = [
  ...
  {
    id: "newsletter-llm",
    label: "Newsletter — fournisseur IA",
    keywords: ["newsletter", "mistral", "openai", "gpt", "claude", "anthropic", "gemini", "google", "ia", "rédaction", "campagne"],
    section: "newsletter",
  ...
  },
  {
    ...
    keywords: ["newsletter", "brevo", "sendinblue", "template", "campagne", "envoi"],
    section: "newsletter",
    externalPage: "newsletter",
  },
  {
