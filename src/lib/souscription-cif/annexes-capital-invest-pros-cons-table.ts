...
export const ANNEXES_CAPITAL_INVEST_PROS_CONS_ROWS: ReadonlyArray<AnnexesScpiProsConsRow> = [
  ...
  },
  {
    ...
    disadvantages:
      "Risque plus élevé, le fonds étant investi directement au capital des entreprises, la performance dépendra des résultats de celle-ci.",
  },
  {
...
export const ANNEXES_CAPITAL_INVEST_SECTION5_RISKS_BODY = `L'investissement en FIP FCPI comporte des risques qu'il convient d'appréhender.
- Risque de perte en capital : les FIP/FCPI n'offrent aucune garantie, ni protection en capital. Il est donc possible que le capital initialement investi ne soit pas intégralement restitué. Par ailleurs, la valorisation du fonds pendant la vie du produit peut évoluer à la hausse et à la baisse.
- Risque lié au sous-jacent : les FIP/FCPI investissent dans des entreprises innovantes ou régionales, cotées ou non cotées, de petite taille qui présentent un risque important et des risques spécifiques qu'il convient d'appréhender.
- Risque de liquidité : les FIP / FCPI peuvent être investis dans des titres cotés ou non-côtés présentant une faible liquidité. Les fonds peuvent donc éprouver des difficultés à céder les titres dans les délais et au prix souhaités. Ces éléments peuvent entraîner une baisse de la valeur liquidative.
- Risques liés aux instruments financiers : Les FIP / FCPI investissent principalement dans des titres cotés ou non cotés présentant des risques importants. Les actifs financiers détenues par les FIP / FCPI sont susceptibles d'entraîner différents risques : risque actions, risque de taux, risque de défaillance de l'émetteur
- Risque lié à la gestion discrétionnaire : les FIP/FCPI sont soumis à un risque lié à la gestion discrétionnaire dans le choix des cibles d'investissement et de l'allocation d'actifs
- Durée de blocage : les FIP/FCPI prévoient une durée minimum de blocage avant laquelle les investisseurs ne peuvent pas récupérer leur épargne (sauf cas de déblocage anticipé prévu au règlement)
- Risque fiscal : La réduction fiscale est conditionnée au respect par le fonds de certains ratios d'investissement. Par ailleurs, la fiscalité applicable peut évoluer du fait des changements législatifs ou de la doctrine. La réduction fiscale est également conditionnée au respect de l'engagement de conservation des parts de FIP/FCPI.
