...
export const SOUSCRIPTION_VARIABLE_LABELS: Record<string, string> = {
  ...
  descriptions_capital_invest: "Descriptions Capital investissement",
  produits_capital_invest_cibles: "Produits Capital investissement (tableau récap)",
  g3f_rendement: "Rendement Girardin (§ 3)",
  g3f_annee_impot: "Année impôt estimé (G3F)",
  g3f_montant_impot: "Montant impôt estimé (G3F)",
  g3f_montant_reduction_souhaitee: "Réduction d'impôt souhaitée (G3F)",
  g3f_montant_apport: "Montant apport nécessaire (G3F)",
  g3f_frais_enregistrement: "Frais d'enregistrement (G3F)",
  g3f_total_apport: "Total apport (G3F)",
  g3f_annee_loi_finances: "Année loi de finances (G3F)",
  g3f_annee_souscription: "Année souscription (G3F)",
  g3f_annee_declaration_revenus: "Année déclaration revenus (G3F)",
