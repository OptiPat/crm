/** Page 5 — Lettre de mission SCPI (articles 6.2 à 9). */
...
Le Conseiller traitera de manière strictement confidentielle tous les documents, analyses et informations recueillis dans le cadre de la Prestation fournie. Par exception, le Conseiller pourra être amené à communiquer à un tiers des informations relatives à la Prestation fournie consécutivement à une obligation légale, réglementaire, judiciaire, administrative ou pour le besoin du contrôle interne de l'association professionnelle à laquelle le Conseiller appartient. Par ailleurs, la Prestation qui sera fournie par le Conseiller procède de l'analyse de la situation spécifique du Client et sera adressée à sa seule attention. En conséquence, les conseils ou services fournis au titre de la Prestation pourront seulement être utilisés par le Client ou toute personne de son entourage préalablement désignée et ne pourront en aucun cas être divulgués ou utilisés par des tiers sans accord préalable du Conseiller.
...
[u]8. Rémunération du Conseiller[/u]

La Prestation convenue entre les Parties au titre de la présente Lettre de Mission sera rémunérée par des honoraires versés par le Client, et/ou par des rémunérations perçues de la part de producteurs de produits ou distributeurs de produits et services financiers, au titre des produits acquis à la suite des conseils prodigués.
...
La Prestation sera exécutée dans le cadre d'une coopération étroite et active entre le Client et son Conseiller. À ce titre, chaque Partie s'engage à maintenir une collaboration régulière en assurant un climat de loyauté et d'efficacité. Les obligations contractuelles de chacune des Parties seront exécutées en toute bonne foi dans le cadre des conditions conjointement convenues.`;
