...
export const ANNEXES_SCPI_RECAP_ROW_RISQUE_CONTENT =
  "Au regard de l'épargne de précaution, des investissements déjà réalisés et la répartition de son patrimoine, cet investissement ne porte pas atteinte à son niveau de confort, ne déséquilibre pas son patrimoine (liquidité / illiquidité).";
