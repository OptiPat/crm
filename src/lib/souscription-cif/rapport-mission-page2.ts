...
Stellium rétrocède au Conseiller une partie des commissions ou avantages non monétaires en rapport avec la fourniture de la prestation de conseil.`;
...
export const RM_PAGE2_ROW_ANALYSE_CONTENT =
...
export const RM_PAGE2_ROW_DURABILITE_TITLE =
  "PRÉFÉRENCE ET JUSTIFICATION EN MATIÈRE DE DURABILITÉ";
...
/** Lignes du tableau page 2 (titre colonne gauche + modèle colonne droite). */
export const RM_PAGE2_RECAP_ROW_TEMPLATES: ReadonlyArray<{
  ...
  { title: RM_PAGE2_ROW_COMPLEMENTAIRES_TITLE, contentTemplate: RM_PAGE2_ROW_QUESTIONS_CONTENT },
];

export const RM_PAGE2_FAIT_A = "Fait à {{client_ville}}, le {{date_document}}.";
