  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newInvestissement: NewInvestissement = {
        ...
        date_souscription: dateSouscription ? Math.floor(new Date(dateSouscription).getTime() / 1000) : undefined,
        date_fin_demembrement: dateFinDemembrement ? Math.floor(new Date(dateFinDemembrement).getTime() / 1000) : undefined,
