...
>(function OrganisationTreeViewport({ children, layoutKey, className }, ref) {
  ...
  return (
    <div className={cn("relative", className)}>
      ...
      <p className="absolute bottom-2 left-2 z-10 text-[10px] text-muted-foreground/70 pointer-events-none select-none hidden sm:block">
        Molette · glisser le fond · double-clic filleul
      </p>

      <div
        ref={containerRef}
        className={cn(
          "w-full h-[min(85vh,calc(100vh-7rem))] min-h-[320px] overflow-hidden overscroll-none touch-none rounded-md",
      ...
      >
        <div className="relative h-full w-full">
          <div
            ref={contentRef}
            className="absolute left-1/2 bottom-4 will-change-transform"
            style={{
