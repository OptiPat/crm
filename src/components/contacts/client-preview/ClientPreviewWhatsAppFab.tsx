...
/** Logo officiel WhatsApp (#25D366). Les ajours laissent passer le fond blanc. */
...
export function ClientPreviewWhatsAppFab({ url }: ClientPreviewWhatsAppFabProps) {
  ...
  return createPortal(
    <a
      ...
      className="absolute right-4 bottom-[max(1rem,env(safe-area-inset-bottom))] z-40 block h-14 w-14 overflow-hidden rounded-full bg-white shadow-lg shadow-black/30 transition-transform hover:scale-105 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25D366]"
    >
